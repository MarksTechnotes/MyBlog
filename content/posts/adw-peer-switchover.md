...
1. Set up a **standby (peer) database** on Exadata Dedicated.  
...
You cannot set up a peer or standby database for an Autonomous Data Warehouse  (ADW-S) instance on an ADW Dedicated (ADW-D) instance or vice-versa.Cross-type Data Guard configurations — between Serverless and Dedicated — are not supported.
